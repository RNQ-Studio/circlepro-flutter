  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          SectionHeader(
              title: l10n.gallerySectionChipVariants,
              subtitle: l10n.gallerySectionChipVariantsDesc),
          const _ChipVariants(),
          SectionHeader(
              title: l10n.gallerySectionBadge,
              subtitle: l10n.gallerySectionBadgeDesc),
          const _BadgeDemo(),
          SectionHeader(
              title: l10n.gallerySectionSearchFilter,
              subtitle: l10n.gallerySectionSearchFilterDesc),
          const _SearchBarFilter(),
          SectionHeader(
              title: l10n.gallerySectionTooltip,
              subtitle: l10n.gallerySectionTooltipDesc),
          const _TooltipShowcase(),
          SectionHeader(
              title: l10n.gallerySectionClipboard,
              subtitle: l10n.gallerySectionClipboardDesc),
          const _ClipboardCopy(),
          SectionHeader(
              title: l10n.gallerySectionImagePicker,
              subtitle: l10n.gallerySectionImagePickerDesc),
          const _ImagePickerDemo(),
          SectionHeader(
              title: l10n.gallerySectionColorPicker,
              subtitle: l10n.gallerySectionColorPickerDesc),
          const _ColorPicker(),
    ...
    return DemoCard(
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            children: _filterChips.entries
                .map((e) => FilterChip(
                      label: Text(e.key),
                      selected: e.value,
                      onSelected: (v) =>
                          setState(() => _filterChips[e.key] = v),
                    ))
                .toList(),
          ),
          const Divider(height: 24),
          ...
          Wrap(
            spacing: 8,
            children: ['Mobile', 'Web', 'Desktop', 'Embedded']
                .map((opt) => ChoiceChip(
                      label: Text(opt),
                        ...
                        : RichText(
                            text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                    text: item.substring(
                                        idx, idx + _query.length),
                                    style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: AppColors.primary,
                                        backgroundColor: Color(0x20006FEE))),
                                TextSpan(
                                    text: item.substring(idx + _query.length)),
                              ],
                            ),
                          ),
                  );
          ...
          ListTile(
            ...
            onTap: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                  content: Text('Fitur ini memerlukan permission device')));
            },
          ),
          ListTile(
